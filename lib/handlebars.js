...
Handlebars.Compiler.prototype = {
  ...
  addPartial: function(mustache, param) {
    ...
    this.fn += "if (typeof fallback['compiledPartials'] === 'undefined') fallback['compiledPartials'] = [];";
    this.fn += "if (!Handlebars.isFunction(fallback['compiledPartials']['" + mustache + "'])) fallback['compiledPartials']['" + mustache + "'] = Handlebars.compile(fallback['partials']['" + mustache + "']);";
    this.fn += "out = out + fallback['compiledPartials']['" + mustache + "'](" + param + ", fallback);";
  },
